...
describe('UsersController', () => {
  ...
  it('create - should use UsersService with correct argument', async () => {
  ...
  it('findOne - should use UsersService with correct argument', async () => {
    const argument = 1;
    const expected = { anyKey: 'anyValue' };
  ...
  it('update - should use UsersService with correct arguments', async () => {
    const argument1 = 1;
  ...
  it('remove - should use UsersService with correct arguments', async () => {
    const argument1 = 1;
  ...
  it('uploadPicture - should use UsersService with correct arguments', async () => {
